...
public class DAO_Supplier implements Service_Supplier{
    ...
    @Override
    public void tambahData(Model_Supplier mod_dis) {
        PreparedStatement st = null;
        String sql = "INSERT INTO supplier(id_supplier,nama_supplier,telp_supplier,alamat_supplier) VALUES (?,?,?,?)";
        try{
            st = connection.prepareStatement(sql);
            st.setString(1, mod_dis.getId_supplier());
            st.setString(2, mod_dis.getNama_supplier());
            st.setString(3, mod_dis.getTelp_supplier());
            st.setString(4, mod_dis.getAlamat_supplier());
    ...
    @Override
    public void perbaruiData(Model_Supplier mod_dis) {
        PreparedStatement st = null;
        String sql = "UPDATE supplier SET nama_supplier=?, telp_supplier=?, alamat_supplier=? WHERE id_supplier=?";
        try{
            st = connection.prepareStatement(sql);
            
            st.setString(1, mod_dis.getNama_supplier());
            st.setString(2, mod_dis.getTelp_supplier());
            st.setString(3, mod_dis.getAlamat_supplier());
            st.setString(4, mod_dis.getId_supplier());
    ...
    @Override
    public void hapusData(Model_Supplier mod_dis) {
        PreparedStatement st = null;
    ...
    @Override
    public List<Model_Supplier> ambilData(int startIndex, int entriesPerPage) {
        PreparedStatement st = null;
        ResultSet rs = null;
